...
public class GameProgress_Multi : MonoBehaviour
{
    public GameObject button;
    private WindowManager_Multi windowManager_Multi;
    ...
    void Awake()
    {
        windowManager_Multi = FindFirstObjectByType<WindowManager_Multi>();
        // 씬 로드 이벤트 등록
    ...
    private IEnumerator StartTimer()
    {
        ...
        windowManager_Multi.DeactivateTotalWindows();
